<div class="row">
    <div class="col-xs-12 header_menu">
        <ul>
            ...
            <li class="@if(Request::is('offers')) active @endif"><div class="header_separator"></div> <a href="https://sb.ghix.net/default.aspx?view=SuperBookingPackages&action=List&HotelID=2986959&Language=4">Offres / Packages</a></li>
